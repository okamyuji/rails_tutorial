...
article_templates = [
  { title: "Getting Started with Ruby on Rails", content: <<~CONTENT },
  ...
  CONTENT
  { title: "Mastering Stimulus Controllers", content: <<~CONTENT },
  ...
  CONTENT
  { title: "Best Practices for Rails Views", content: <<~CONTENT },
  ...
  CONTENT
  { title: "Form Handling in Rails", content: <<~CONTENT }
