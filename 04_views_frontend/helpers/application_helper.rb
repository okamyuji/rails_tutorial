...
module ApplicationHelper
  ...
  def error_messages_for(object, options = {})
    ...
    title = options[:title] || "#{pluralize(object.errors.count, 'error')} prohibited this from being saved:"
  ...
  def field_error_message(object, field)
    ...
    content_tag :span, object.errors[field].first, class: 'error-message text-danger'
  end
