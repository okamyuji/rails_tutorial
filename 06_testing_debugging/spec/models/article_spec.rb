...
RSpec.describe Article, type: :model do
  ...
  describe '.search' do
    let!(:article) { create(:article, title: 'Ruby on Rails Tutorial', content: 'Learn Rails basics') }
    let!(:other) { create(:article, title: 'Python Guide', content: 'Learn Python basics') }
