...
article_data = [
  {
    ...
    content:
      "This article explains how to implement user authentication in Rails using Devise...",
    published: true
  },
  {
    title: "Understanding Pundit for Authorization",
    content:
      "Pundit provides a simple way to organize authorization logic in your Rails application...",
    published: true
  },
  {
    title: "Secure Session Management in Rails",
    content:
      "Learn how to properly manage sessions and cookies in your Rails application...",
    published: true
  },
  {
    title: "OAuth Integration with OmniAuth",
    content:
      "This guide shows how to integrate Google, Facebook, and GitHub authentication...",
    published: true
  },
  {
